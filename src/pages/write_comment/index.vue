<template>
  <div class="compose">
    ...
    <div class="content-preview">
      <textarea-autosize rows="3" ref="textarea" v-model="newRecordData.content" placeholder="说说分享心得..."/>
      <van-uploader
...
<script>
import Vue from 'vue'
import { Swipe, SwipeItem, Uploader } from 'vant'
...
export default {
  ...
  computed: {
    ...
    safeContent () {
      return this.newRecordData.content.replace(/[<|>]/g, '')
    }
  },
  watch: {
  ...
  methods: {
    ...
    newWeibo () {
      ...
      if (this.newRecordData.content === '' && this.aboutUploadFile.files.length > 0) {
        this.newRecordData.content = '转发微博'
      }
    ...
    .content-preview {
      ...
      .van-uploader {
        ...
        .upload-area {
          ...
          align-items: center;
          border: 1px dashed rgba($color1, .5);
